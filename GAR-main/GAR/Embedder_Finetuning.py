...
class EmbedderFinetuner:
    ...
    def load_datasets(self, names: list, markdown_dir: str = "Markdown", qrels_dir: str = None):
        qrels_base = qrels_dir or os.getcwd()
        ...
        for name in names:
            ...
            qrels_path = os.path.join(qrels_base, f'{name}_qrels.tsv')
